    ...
    <v-card class="mb-4 elevation-2 flex-shrink-0" shaped>
      ...
      <v-toolbar color="surface" density="compact" class="border-b px-2">
        <v-tabs v-model="activeTab" color="primary">
          <v-tab value="vehicles"><v-icon start>mdi-tank</v-icon> Vehicles</v-tab>
...
watch([activeTab, searchQuery], () => {
  if (currentOptions.value) { currentOptions.value.page = 1; loadItems(currentOptions.value); }
});
